...
**Frase de Impacto:** *"Eu entrego código e soluções de dados de alta qualidade com direcionamento do time"*
...
- **Craft** - Foco principal em melhorar minhas habilidades técnicas
...
**Frase de Impacto:** *"Eu sou prolífico em entregar projetos resilientes e sustentáveis de dados e software do design à implementação e rollout"*
...
**Frase de Impacto:** *"Eu identifico e entrego soluções completas através de marcos bem definidos, abrangendo produtos ou sistemas multi-componente no domínio de dados"*
...
- Lidero tecnicamente projetos relevantes no domínio
...
### Impact Levers (Alavancas de impacto)
- **Project Leadership** - Defino e entrego marcos bem definidos de projetos. Sou líder técnico de projetos no meu time
- **Product Expertise** - Mantenho necessidades dos clientes em mente e uso input de stakeholders para determinar soluções técnicas certas
- **Mentorship** - Elevo ativamente membros menos experientes do time
- **Technical Excellence** - Estabeleço o padrão técnico através de revisões e boas práticas
...
**Frase de Impacto:** *"Eu defino a estratégia técnica e de dados multi-ano e multi-time e a entrego através de implementação direta ou liderança técnica ampla"*
...
- **Product Expertise** - Influencio cada vez mais ou tomo decisões de produto/escopo e determino os trade-offs técnicos certos para entregar valor ao cliente rapidamente
...
**Frase de Impacto:** *"Eu defino e conduzo a estratégia técnica organizacional de multi-ano através de múltiplos times e domínios"*
...
**Frase de Impacto:** *"Eu estabeleço direção técnica para a empresa e impulsiono impacto através de múltiplas organizações"*
...
1. **Para Autoavaliação:** Compare seu escopo, alcance e alavancas de impacto atual com a descrição do seu nível e do próximo
2. **Para Planos de Desenvolvimento:** Identifique gaps entre seu nível atual e o próximo para criar plano de crescimento
3. **Para Gestores:** Use como referência em conversas de carreira, promoções e expectativas de performance
4. **Para Contratação:** Alinhe expectativas de níveis em processos seletivos
...
```
SE I (Junior) → SE II (Pleno) → SE III (Senior) → Lead Engineer → Staff I → Staff II → Principal
    ↓                                                    ↓
Learning & Craft                              Technical Leadership & Strategy
```

**Transições Chave:**
- **SE I → SE II:** De execução guiada para autonomia em projetos definidos
- **SE II → SE III:** De projetos definidos para resolver problemas ambíguos e liderar tecnicamente
- **SE III → Lead:** De liderança de projeto para liderança de time/domínio e estratégia
- **Lead → Staff:** De impacto em time único para impacto multi-time
- **Staff I → Staff II:** De domínio único para múltiplos domínios e influência organizacional
- **Staff II → Principal:** De impacto organizacional para impacto em nível de empresa e indústria
