...
- Atuo como ponte entre executores (SE I/II/III) e stakeholders
...
- Garanto qualidade através de code reviews atentos em 100% dos PRs críticos
...
- Decido quando escalar decisões para Staff/Principal Engineers
- Considero backward compatibility e estratégias de versionamento
- Tomo decisões no timing certo, evitando paralisia por análise
- Comunico decisões técnicas de forma clara para time e stakeholders
...
- Desbloqueo time rapidamente através de pair programming ou decisões técnicas
...
- Desenvolvo capacidades técnicas através de **pair programming regular** (mínimo 2-3x por semana)
- Forneço **feedback construtivo e frequente** em code reviews com explicação do "porquê"
...
- Participo ativamente de hiring e onboarding de novos membros
- Crio plano de onboarding técnico de 30-60-90 dias para novos membros
...
- Traduzo jargão técnico para linguagem acessível aos stakeholders
- Participo de sync meetings com times dependentes
- Promovo cultura de code reviews construtivos e educativos
...
- Conduzo **post-mortems blameless** focados em melhorias sistêmicas
- Modelo **work-life balance** e sustentabilidade (não heroísmo)
...
- Mantenho **transparência** sobre status técnico, riscos e trade-offs
- Realizo demos de features completadas para stakeholders
...
- Faço code reviews em 100% dos PRs críticos do time
- Uso mesmas ferramentas e stack que o time

### Arquitetura & Design
- Projeto arquitetura de sistemas do time considerando requisitos de:
  - Escalabilidade (crescimento de dados, usuários, features)
  - Confiabilidade (SLIs/SLOs, fault tolerance, disaster recovery)
  - Developer Experience (facilidade de mudança, testabilidade)
  - Custo (compute, storage, manutenção)
- Defino **contratos de API, data models e interfaces** que facilitam consumo
- Considero **backward compatibility** e estratégias de versionamento
- Crio exemplos de código e templates que servem como referência
...
Defino e comunico visão técnica alinhada com necessidades dos usuários (internos ou externos), priorizando impacto real nas entregas do time.

### 💡 Paixão por Inovar
Identifico oportunidades de melhoria técnica que geram valor, experimento novas tecnologias através de POCs e promovo cultura de experimentação no time.

### ⚡ Agilidade para Resultado
Balanço necessidades de curto prazo com saúde técnica de longo prazo, tomo decisões técnicas rapidamente quando necessário e garanto predictabilidade nas entregas.

### 💰 Fazer Mais com Menos
Simplifico arquiteturas, reduzo complexidade desnecessária e automatizo trabalho repetitivo, maximizando produtividade do time.

### 🤝 Juntos!
Facilito comunicação saudável dentro do time, promovo segurança psicológica, celebro sucessos coletivamente e desenvolvo futuros líderes técnicos.

---

## 🔍 Diferença entre Tech Lead, Lead Engineer, Staff e EM

| Aspecto | Lead Engineer (IC) | **Tech Lead** | Staff Engineer (IC) | Engineering Manager |
|---------|-------------------|---------------|-------------------|---------------------|
...
| **Responsabilidade** | Entrega técnica complexa | **Entrega e qualidade do time** | Direção técnica org | Performance, crescimento, engajamento |
...
### 1. Arquitetura & Design (Nível Time)
- Projetar arquitetura de sistemas do time
- Definir contratos de API, data models e interfaces
- Manter documentação arquitetural atualizada
- Considerar backward compatibility

### 2. Code Quality & Best Practices
- Realizar code reviews em 100% dos PRs críticos
...
- Desbloquear time através de pair programming
- Identificar slippage e ajustar plano
- Realizar demos para stakeholders

### 5. Operação & Confiabilidade
- Definir SLIs/SLOs
...
- Pair programming regularmente (2-3x por semana)
- Oferecer feedback educativo em code reviews
- Delegar features desafiadoras estrategicamente
- Compartilhar conhecimento (workshops, lunch & learns)

### 7. Comunicação
- Escrever design docs para features significativas
- Comunicar mudanças proativamente
- Participar de sync meetings com times dependentes
- Manter docs atualizados

### 8. Cultura de Time
- Modelar comportamentos de excelência
- Celebrar wins do time
- Conduzir post-mortems blameless
...
- Onboarding técnico de novos membros (30-60-90 dias)
...
- ✅ Código do time tem alta qualidade e baixa taxa de bugs
- ✅ Stakeholders confiam nas estimativas e entregas do time
- ✅ Time se sente empoderado e com segurança psicológica
- ✅ Você é reconhecido como referência técnica no domínio
- ✅ Documentação técnica é atualizada e útil
- ✅ Time opera de forma sustentável (sem heroísmo constante)
